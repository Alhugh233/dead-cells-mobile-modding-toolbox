...
class MainActivity : Activity(), App.ServiceStateListener {
    ...
    override fun onServiceStateChanged(service: XposedService?) {
        ...
        binding.pakTool.setOnClickListener {
            val intent = Intent()
            intent.setClassName(this@MainActivity, "io.github.libxposed.example.PakActivity")
            startActivity(intent)
        }
        binding.about.setOnClickListener {
            val intent = Intent()
            intent.setClassName(this@MainActivity, "io.github.libxposed.example.AboutActivity")
            startActivity(intent)
        }
    }
}
